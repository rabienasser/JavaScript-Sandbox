...
// loginUser('robnas12@gmailc.kom', 12345)
...
// Handle promises for ALL function at once:
// loginUser('robnas2@gmail.com', 12345)
// .then(res => getUserVideos(res.email))
// .then(res => console.log(res[2]))
// .catch(err => console.log(err))

// // Handling all promises at once
// Promise.all([loginUser(), getUserVideos()])
// .then(res => console.log(res))
...
async function displayUser() {
    try {
        const loggedUser = await loginUser('robnaser13@gmail.com', 12345)
